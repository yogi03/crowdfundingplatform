    ...
    <div className="sm:w-[288px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer" onClick={handleClick}>
      ...
      <div className="flex flex-col p-4">
        <div className="flex flex-row items-center mb-[18px]">
          <img src="https://img.icons8.com/material-outlined/24/000000/tag.png" alt="tag" className="w-[17px] h-[17px] object-contain invert opacity-50"/>
        ...
        <div className="flex justify-between flex-wrap mt-[15px] gap-2">
          ...
          <div className="flex flex-col">
            <h4 className="font-epilogue font-semibold text-[14px] text-[#b2b3bd] leading-[22px]">{remainingDays(deadline)}</h4>
