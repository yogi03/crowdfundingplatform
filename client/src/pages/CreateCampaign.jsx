...
const CreateCampaign = () => {
  ...
  return (
    <div className="dark:bg-[#1c1c24] bg-white flex justify-center items-center flex-col rounded-[10px] sm:p-10 p-4 border dark:border-gray-700 border-gray-200">
      {isLoading && <Loader />}
      <div className="flex justify-center items-center p-[16px] sm:min-w-[380px] dark:bg-[#3a3a43] bg-gray-100 rounded-[10px]">
        <h1 className="font-epilogue font-bold sm:text-[25px] text-[18px] leading-[38px] dark:text-white text-gray-900">
          Start a Campaign
        </h1>
      </div>
      ...
      >
        <div className="flex flex-wrap gap-[40px]">
          <div className="flex-1 flex flex-col">
            <span className="font-epilogue font-medium text-[14px] leading-[22px] dark:text-[#808191] text-gray-600 mb-[10px]">
              Your Name *
            </span>
            <input
              required
              ...
              className="py-[15px] sm:px-[25px] px-[15px] outline-none border-[1px] dark:border-[#3a3a43] border-gray-300 dark:bg-transparent bg-white font-epilogue dark:text-white text-gray-900 text-[14px] dark:placeholder:text-[#4b5264] placeholder:text-gray-400 rounded-[10px] sm:min-w-[300px]"
            />
          </div>
          <div className="flex-1 flex flex-col">
            <span className="font-epilogue font-medium text-[14px] leading-[22px] dark:text-[#808191] text-gray-600 mb-[10px]">
