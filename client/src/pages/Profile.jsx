...
const Profile = () => {
  ...
  return (
    <div>
      <h1 className="font-epilogue font-bold text-[18px] text-white text-left text-foreground">Your Campaigns ({campaigns.length})</h1>

      <div className="flex flex-wrap mt-[20px] gap-[26px]">
        {isLoading && (
          <Loader title="Fetching your campaigns..." />
        )}
